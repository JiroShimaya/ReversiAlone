 ...
 * This code is based on Juraj Bubniak's (https://github.com/jbub/reversi-js)
 * modified by Jiro Shimaya at 2018/12/27
*/
var reversi = {
    ...
    initGame: function() {
        ...
        // init placement
        var initRow = this.rows/2, initCol = this.cols/2;
        this.setItemState(initRow, initCol, this.states.white);
        this.setItemState(initRow, initCol+1, this.states.black);
        this.setItemState(initRow+1, initCol, this.states.black);
        this.setItemState(initRow+1, initCol+1, this.states.white);
    ...
    move: function(row, col) {
        ...
        if (finalItems.length) {
            ...
            //add by shimaya
            var newScore = Number($('.score-alone').text())+reversed;
            console.log(JSON.stringify(finalItems));
            $('.score-alone').text(newScore);
            $('.score-alone').css('color',(current.id === this.states.black.id) ? this.states.white.color : this.states.black.color);
        }
